...
cpf = '746.824.890-70'
# Remover pontos e hífen para obter os 9 primeiros dígitos
...
# Se o resultado for maior que 9, o dígito é 0, caso contrário, é o próprio resultado
...
# Remover pontos e hífen do CPF original para a comparação
cpf_sem_formatacao = cpf.replace('.', '').replace('-', '')

if cpf_sem_formatacao == cpf_gerado_pelo_calculo:
